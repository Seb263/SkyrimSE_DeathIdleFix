...
Fixes a bug where dead NPCs may appear standing or tilted in an idle pose instead of ragdolling after a loading screen. Restores proper physics to affected corpses to maintain immersion. Safe to install or uninstall mid-game. No plugin, no scripts.

The mod can be downloaded here: [nexusmods.com](https://www.nexusmods.com/skyrimspecialedition/mods/152344)
